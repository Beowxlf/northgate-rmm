...
recovers valid dual-link intermediate states for both active quarantine and
rejected rollover. The runtime replays pending rollover audits after restart and
deletes each payload only after its audit is acknowledged. The active spool
therefore remains available after prolonged expiry or rejection.
