...
| RMM-NET-032 | `TBD exact Z6 emergency-evidence reconciler firewall alias`  | `TBD protected Z5 recovery-audit intake`                 | `TBD approved TLS port`          | Required before G2; write only the exact accepted fallback bundle plus original Z6 acknowledgement after Z5 re-establishment; no unrelated read, alter, or delete authority       | Security evidence owner | `NG-CHG-20260830-001` |
...
- successful reconciliation of a disposable Z6 emergency-evidence bundle into
  the protected Z5 recovery-audit intake after Z5 re-establishment;
