...
| R-013 | GitHub repository controls are absent/misconfigured | Medium | High | private creation, branch protection, CODEOWNERS, audit | Project owner | Blocks remote completion |
| R-014 | Licensing is undefined before public distribution | Medium | Medium | private repository; license decision before public release | Project owner | Blocks public release |
