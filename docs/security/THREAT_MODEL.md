...
| TM-38 | Compromised coordinator bypasses rollout health gates | carried signed approval and Z5 attestation; repository verifies role, scope, freshness, and digest | reject status, isolate coordinator, freeze rollout, preserve evidence     |
