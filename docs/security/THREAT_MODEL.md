...
| TM-19 | Compromised TLS service blocks its own containment    | disable separate issuance client first, then revoke/roll served certificate through Z1            | deny reissuance, rebuild Z2, provision new client, preserve evidence     |
