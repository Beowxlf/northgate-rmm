...
| TM-25 | Release transition bypasses protected audit           | independent Z5/Z6 acknowledgement, digest/correlation binding, fail-closed transition             | audit-gap alert, freeze release, reconcile fallback and Z5 evidence      |
