...
Browser desktop access uses Guacamole with Windows NLA or explicitly configured, certificate-pinned Linux xrdp TLS. Native Windows/Linux RDP downloads are also available; see [credential handling](native-desktop-credentials.md).
